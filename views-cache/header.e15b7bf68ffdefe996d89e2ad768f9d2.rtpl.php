...
<html lang="pt-br">
  <head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="/git/ecommerce/res/site/css/bootstrap.min.css">
    
    <!-- Font Awesome -->
    <link rel="stylesheet" href="/git/ecommerce/res/site/css/font-awesome.min.css">
    
    <!-- Custom CSS -->
    <link rel="stylesheet" href="/git/ecommerce/res/site/css/owl.carousel.css">
    <link rel="stylesheet" href="/git/ecommerce/res/site/css/style.css">
    <link rel="stylesheet" href="/git/ecommerce/res/site/css/responsive.css">
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="#"><img src="/git/ecommerce/res/site/img/logo.png"></a></h1>
                    </div>
                </div>
